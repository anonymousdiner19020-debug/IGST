...
export const FALLBACK_DISHES: Dish[] = [
  {
    ...
    emoji: "🥨",
    unlock_level: 1,
    base_recipe: { dough: 3, salt: 3 },
    topping_options: ["cheese_sauce", "mustard", "spicy", "cinnamon_sauce", "chocolate_sauce", "pizza_sauce", "american"],
    verb: "twist",
    reward_coins: 40,
    moves: 24,
  ...
  },
  {
    ...
    emoji: "🧁",
    unlock_level: 2,
    base_recipe: { pb_cake: 3, chocolate_cake: 3 },
    topping_options: ["butterscotch_cake", "mini_pie", "chocolate_sauce", "sprinkles"],
    verb: "box",
    reward_coins: 55,
    moves: 24,
    customers_per_level: 3,
  },
  {
    ...
    unlock_level: 3,
    base_recipe: { cup: 3 },
    topping_options: ["cherry", "rootbeer", "lemon", "blueberry", "ice_cream", "sprinkles"],
    verb: "scoop",
    reward_coins: 65,
    moves: 24,
    customers_per_level: 3,
  },
  {
    ...
    emoji: "🥖",
    unlock_level: 4,
    base_recipe: { roll: 3, ham: 3 },
    topping_options: ["lettuce", "tomato", "onion", "mayo", "oil", "cheese", "bologna", "salami"],
    verb: "build",
    reward_coins: 80,
    moves: 28,
  ...
  },
  {
    ...
    emoji: "🥖",
    unlock_level: 5,
    base_recipe: { roll: 3, salami: 3 },
    topping_options: ["lettuce", "tomato", "onion", "mayo", "oil", "provolone", "capicola", "pepperoni"],
    verb: "build",
    reward_coins: 95,
    moves: 28,
    customers_per_level: 4,
  },
  {
    ...
    topping_options: ["onion", "mushroom", "hot_pepper", "american", "provolone", "whiz"],
    verb: "grill",
    reward_coins: 110,
    moves: 28,
    customers_per_level: 4,
  },
  {
    ...
    emoji: "🥓",
    unlock_level: 7,
    base_recipe: { pork: 4, roll: 2 },
    topping_options: ["broccoli", "spinach", "provolone", "american"],
    verb: "roast",
    reward_coins: 130,
    moves: 30,
